<script>
    import { providerReachable, projects, tasks, blockedTasks, highRoiTasks, view } from '$lib/stores';
...
<header>
    <div class="stat-bar">
        ...
        <div class="stat-item"><span class="stat-value">{blocked}</span><span class="stat-label">Blocked</span></div>
    ...
    <div class="header-actions">
        ...
        <button class="btn {$view === 'dashboard' ? 'active-nav' : ''}" on:click={() => view.set('dashboard')}>
            Dashboard
        </button>
