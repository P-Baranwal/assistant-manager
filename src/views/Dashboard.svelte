...
<div class="tabs mb-4" role="tablist">
    <div class="tab {currentTab === 'active' ? 'active' : ''}" 
         ...
         onkeydown={(e) => (e.key === 'Enter' || e.key === ' ') && (currentTab = 'active')}>
    ...
    <div class="tab {currentTab === 'completed' ? 'active' : ''}" 
         ...
         onkeydown={(e) => (e.key === 'Enter' || e.key === ' ') && (currentTab = 'completed')}>
...
{#if currentTab === 'active'}
    {#if $priorityList.length === 0}
        <div class="empty-state">
            ...
            <button class="btn btn-primary mt-4" onclick={() => view.set('add')}>Add Assignment</button>
        </div>
    {:else}
        <div class="card-list">
            {#each $priorityList as t, i}
                ...
                <div class="card card-hover" 
                     ...
                     onkeydown={(e) => (e.key === 'Enter' || e.key === ' ') && openDetail(t.id)}
                    ...
                    <div class="card-header">
                        <div>
                            ...
                            <!-- XSS fixed: Svelte escapes {t.title} automatically! -->
...
{#if currentTab === 'completed'}
    {#if $completedList.length === 0}
        <div class="empty-state">
            <h3 class="text-muted">No completed assignments yet</h3>
        </div>
    {:else}
        <div class="card-list">
